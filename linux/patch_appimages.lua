...
for _, platform in ipairs(LINUX_PLATFORMS) do
    ...
    print("Adding in License files...")
    fs.rename("squashfs-root/license.txt", "squashfs-root/LOVE-license.txt")
    fs.copy("LIKO-12-license.txt", "squashfs-root/LIKO-12-license.txt")
